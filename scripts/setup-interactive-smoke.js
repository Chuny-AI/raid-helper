...
const dashboard = ui.buildDashboard({ status, userId: 'user-1', guildId: 'guild-1' });
...
const economy = ui.buildEconomyScreen({ status, userId: 'user-1', guildId: 'guild-1' });
...
const clearConfirmation = ui.buildEconomyClearConfirmation({ userId: 'user-1', guildId: 'guild-1' });
