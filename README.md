...
- **Templates**: Define your custom embed templates in the `/templates` folder.
- **Settings**: Adjust embed appearance, including colors, text, and images by modifying the configuration objects in the backend.
